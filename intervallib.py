...
#            return False
    ...
    def getPromoter(self,promSize):
        if self.strand == "+":
            align = Interval(self.chr,self.start-promSize,self.start+promSize,self.strand,name=self.name+"_promoter")
        elif self.strand == "-":
            align = Interval(self.chr,self.end-promSize,self.end+promSize,self.strand,name = self.name+"_promoter")
        return align  
